...
{
    public class HeroAnimator : HeroMotor
    {
        #region Variables                
        ...
        public virtual void UpdateAnimator()
        {
            ...
            animator.SetBool(AnimatorParameters.IsAttack, isAttack); ;
    ...
    public static partial class AnimatorParameters
    {
        ...
        public static int isGrandAttack = Animator.StringToHash("IsGrandAttack");
        public static int isPowerAttack = Animator.StringToHash("IsPowerAttack");
    }
}